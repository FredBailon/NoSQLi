...
BOOLEAN_REPETITIONS = _get_int("BOOLEAN_REPETITIONS", "3")
BOOLEAN_MIN_CONFIRMATIONS = _get_int("BOOLEAN_MIN_CONFIRMATIONS", "2")
ERROR_REPETITIONS = _get_int("ERROR_REPETITIONS", "3")
ERROR_MIN_CONFIRMATIONS = _get_int("ERROR_MIN_CONFIRMATIONS", "2")
STRUCTURAL_DIFF_THRESHOLD = _get_float("STRUCTURAL_DIFF_THRESHOLD", "0.2")
